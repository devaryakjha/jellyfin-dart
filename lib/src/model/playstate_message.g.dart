...
abstract class _$PlaystateMessageCWProxy {
  PlaystateMessage data(PlaystateRequest? data);

  PlaystateMessage messageId(String? messageId);
...
PlaystateMessage _$PlaystateMessageFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      ...
      json,
      ($checkedConvert) {
        final val = PlaystateMessage(
          data: $checkedConvert(
            'Data',
            (v) => v == null
                ? null
                : PlaystateRequest.fromJson(v as Map<String, dynamic>),
          ),
