...
abstract class _$PlaybackStartInfoCWProxy {
  PlaybackStartInfo canSeek(bool? canSeek);

  PlaybackStartInfo item(BaseItemDto? item);

  PlaybackStartInfo itemId(String? itemId);

  PlaybackStartInfo sessionId(String? sessionId);
  ...
  PlaybackStartInfo isPaused(bool? isPaused);

  PlaybackStartInfo isMuted(bool? isMuted);
  ...
  PlaybackStartInfo brightness(int? brightness);
...
class _$PlaybackStartInfoCWProxyImpl implements _$PlaybackStartInfoCWProxy {
  ...
  PlaybackStartInfo call({
    ...
    Object? playbackStartTimeTicks = const $CopyWithPlaceholder(),
    Object? volumeLevel = const $CopyWithPlaceholder(),
    Object? brightness = const $CopyWithPlaceholder(),
    ...
    return PlaybackStartInfo(
      ...
      playbackStartTimeTicks:
          playbackStartTimeTicks == const $CopyWithPlaceholder()
          ? _value.playbackStartTimeTicks
          // ignore: cast_nullable_to_non_nullable
          : playbackStartTimeTicks as int?,
      volumeLevel: volumeLevel == const $CopyWithPlaceholder()
          ? _value.volumeLevel
          // ignore: cast_nullable_to_non_nullable
          : volumeLevel as int?,
      brightness: brightness == const $CopyWithPlaceholder()
          ? _value.brightness
          // ignore: cast_nullable_to_non_nullable
          : brightness as int?,
...
PlaybackStartInfo _$PlaybackStartInfoFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'PlaybackStartInfo',
  json,
  ($checkedConvert) {
    final val = PlaybackStartInfo(
      ...
      playbackStartTimeTicks: $checkedConvert(
        'PlaybackStartTimeTicks',
        (v) => (v as num?)?.toInt(),
      ),
      volumeLevel: $checkedConvert('VolumeLevel', (v) => (v as num?)?.toInt()),
      brightness: $checkedConvert('Brightness', (v) => (v as num?)?.toInt()),
