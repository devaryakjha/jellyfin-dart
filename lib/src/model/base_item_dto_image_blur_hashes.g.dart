...
abstract class _$BaseItemDtoImageBlurHashesCWProxy {
  BaseItemDtoImageBlurHashes primary(Map<String, String>? primary);

  BaseItemDtoImageBlurHashes art(Map<String, String>? art);
  ...
  BaseItemDtoImageBlurHashes box(Map<String, String>? box);
...
class _$BaseItemDtoImageBlurHashesCWProxyImpl
  ...
  final BaseItemDtoImageBlurHashes _value;
...
BaseItemDtoImageBlurHashes _$BaseItemDtoImageBlurHashesFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  'BaseItemDtoImageBlurHashes',
  json,
  ($checkedConvert) {
    final val = BaseItemDtoImageBlurHashes(
...
Map<String, dynamic> _$BaseItemDtoImageBlurHashesToJson(
  BaseItemDtoImageBlurHashes instance,
) => <String, dynamic>{
