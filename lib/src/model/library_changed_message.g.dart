...
abstract class _$LibraryChangedMessageCWProxy {
  LibraryChangedMessage data(LibraryUpdateInfo? data);

  LibraryChangedMessage messageId(String? messageId);

  LibraryChangedMessage messageType(SessionMessageType? messageType);

  /// This function **does support** nullification of nullable fields. All `null` values passed to `non-nullable` fields will be ignored. You can also use `LibraryChangedMessage(...).copyWith.fieldName(...)` to override fields one at a time with nullification support.
  ///
  /// Usage
  /// ```dart
  /// LibraryChangedMessage(...).copyWith(id: 12, name: "My name")
  /// ````
  LibraryChangedMessage call({
...
/// Proxy class for `copyWith` functionality. This is a callable class and can be used as follows: `instanceOfLibraryChangedMessage.copyWith(...)`. Additionally contains functions for specific fields e.g. `instanceOfLibraryChangedMessage.copyWith.fieldName(...)`
class _$LibraryChangedMessageCWProxyImpl
    implements _$LibraryChangedMessageCWProxy {
  const _$LibraryChangedMessageCWProxyImpl(this._value);

  final LibraryChangedMessage _value;

  @override
  LibraryChangedMessage data(LibraryUpdateInfo? data) => this(data: data);
...
extension $LibraryChangedMessageCopyWith on LibraryChangedMessage {
  /// Returns a callable class that can be used as follows: `instanceOfLibraryChangedMessage.copyWith(...)` or like so:`instanceOfLibraryChangedMessage.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$LibraryChangedMessageCWProxy get copyWith =>
      _$LibraryChangedMessageCWProxyImpl(this);
}
...
LibraryChangedMessage _$LibraryChangedMessageFromJson(
  ...
  json,
  ($checkedConvert) {
    final val = LibraryChangedMessage(
      data: $checkedConvert(
        'Data',
        (v) => v == null
            ? null
            : LibraryUpdateInfo.fromJson(v as Map<String, dynamic>),
      ),
