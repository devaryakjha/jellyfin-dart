...
abstract class _$LibraryChangedMessageCWProxy {
  ...
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `LibraryChangedMessage(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
...
/// Use as `instanceOfLibraryChangedMessage.copyWith(...)` or call `instanceOfLibraryChangedMessage.copyWith.fieldName(value)` for a single field.
class _$LibraryChangedMessageCWProxyImpl
  ...
  @override
  LibraryChangedMessage data(LibraryUpdateInfo? data) => call(data: data);
...
extension $LibraryChangedMessageCopyWith on LibraryChangedMessage {
  ...
  /// Example: `instanceOfLibraryChangedMessage.copyWith(...)` or `instanceOfLibraryChangedMessage.copyWith.fieldName(...)`.
